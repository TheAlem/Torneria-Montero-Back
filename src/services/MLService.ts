...
import {
  businessSecondsBetweenSigned,
  calculateSuggestedDueDate as calculateSuggestedDueDateFromCalendar,
  getWorkerSchedule,
} from './WorkCalendarService.js';
...
export async function calculateSuggestedDueDate(
  ...
  return calculateSuggestedDueDateFromCalendar(estimatedSec, workerId, fromDate);
}
